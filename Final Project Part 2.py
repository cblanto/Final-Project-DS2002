...
with open('/Users/coleblanton/Desktop/Discord Bot/pixar__studio12.csv', 'r') as data_file:
...
impersonated_role = f"""
    From now on, you are going to act as {name}. Your role is {role}. By the way, don't say 'As the Pixar Team' for every answer.
...
@client.command(brief='Pixar Movies...if i implemented it', description='Pixar Movies')
async def record(ctx):
    await ctx.send("Hello, this bot will help answer questions related to Pixar Movies. you can enter !Record, !Exit or just ask a question")
